function(pf_m4_json_escape input output)
    set(value "${input}")
...
function(pf_generate_m4_owner_checklist registry_path output_path)
    ...
    foreach(row_id RANGE 1 61)
        ...
        pf_m4_json_escape("${technique}" technique_json)
        pf_m4_json_escape("${status}" status_json)
        pf_m4_json_escape("${recipe}" recipe_json)
