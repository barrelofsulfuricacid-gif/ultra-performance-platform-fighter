...
void pf_web_m4_playtest_render(
    const int32_t *view,
    int view_count);
void pf_web_m4_playtest_observe_inputs(
...
static int test_dynamic_view_contract(void)
{
    ...
    player.hitbox_left_q16 = INT32_C(101);
    player.hitbox_right_q16 = INT32_C(202);
    player.hitbox_top_q16 = -INT32_C(303);
    player.hitbox_bottom_q16 = INT32_C(404);
    player.hit_sphere_count = UINT8_C(2);
    player.hit_spheres[0].center_x_q16 = INT32_C(1001);
    player.hit_spheres[0].center_y_q16 = INT32_C(1002);
    player.hit_spheres[0].radius_q16 = INT32_C(1003);
    ...
    player.hit_spheres[1].center_x_q16 = INT32_C(2001);
    player.hit_spheres[1].center_y_q16 = INT32_C(2002);
    player.hit_spheres[1].radius_q16 = INT32_C(2003);
    ...
    player.shield_left_q16 = -INT32_C(501);
    player.shield_right_q16 = INT32_C(502);
    player.shield_top_q16 = -INT32_C(503);
    player.shield_bottom_q16 = INT32_C(504);
    player.shield_tilt_x = -INT16_C(505);
    player.shield_tilt_y = INT16_C(506);

    return pf_web_m4_playtest_test_render_dynamic_player(&player, 3) &&
