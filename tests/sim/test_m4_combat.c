    ...
    const pf_content_view *view)
{
    ...
    if (!expect_status(
            ...
            "smash-charge-save") ||
        destination.size != save_size ||
        memcmp(save_bytes, "PFSAVE43", (size_t)8) != 0)
    {
