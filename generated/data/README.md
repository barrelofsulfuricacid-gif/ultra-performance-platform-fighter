...
and includes complete 11-capsule Falcon hurt poses. Initial Dash and RunBrake
also use complete displayed-frame pose tracks indexed through a compact common-
state table that reuses the same deduplicated capsule pool. Raw captures and
