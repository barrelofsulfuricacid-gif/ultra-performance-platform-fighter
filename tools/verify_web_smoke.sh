...
pf_require_dom \
    ...
    'replay=pass ticks=180 winner_mask=5 final_sha256=d015347ede291c4f8f3dd08cc794ac12d04a74bc1b789d5ecb86facef7e36745'
pf_require_dom \
    "replay inspector" \
    'id="pf-replay-inspector"'
pf_require_dom \
    "M4 input/IDJ/ground-dodge/air-facing/air-dodge/combat/event-journal/reaction/shield/tumble/floor/surface-tech probe status" \
    'playtest=ready input_probe=pass air_facing_probe=pass instant_double_jump_probe=pass edge_hop_probe=pass edge_dash_probe=pass fox_trot_probe=pass pivot_probe=pass dash_cancel_probe=pass dashing_shield_probe=pass combat_probe=pass event_journal_probe=pass reaction_probe=pass shield_probe=pass shield_break_probe=pass powershield_cancel_probe=pass tumble_probe=pass floor_recovery_probe=pass surface_tech_probe=pass air_dodge_probe=pass ground_dodge_probe=pass aerial_l_cancel_probe=pass match_probe=pass controls=keyboard-two-player'
pf_require_dom \
    "M4 playtest surface" \
    'id="pf-m4-playtest"'
pf_require_dom \
