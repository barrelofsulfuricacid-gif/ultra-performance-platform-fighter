...
compiler=${CC:-cc}
expected='m4-charge=pass content_schema=78 state_schema=77 save_bytes=1783 charge_invariants=28 charge_storage_cancel=1 resumed_release=1 replay=1 rl=1'
