...
def emit(
    ...
    lines.extend(
        [
            "};",
            "",
            "typedef struct pf_m4_hsd_transition_production_case",
            "{",
            "    uint32_t trace_frame;",
            ...
            "    pf_m4_hsd_compact_pose expected_target_compact;",
            "    pf_m4_hsd_compact_pose expected_compact;",
            "} pf_m4_hsd_transition_production_case;",
            "",
            "static const pf_m4_hsd_transition_production_case",
            "    pf_m4_hsd_transition_production_cases[] = {",
        ]
    )
