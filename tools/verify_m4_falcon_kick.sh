...
build_dir=${5:-"$root/build/wsl-release"}
output_dir=${6:-/tmp/m4_falcon_kick}
...
echo "m4-falcon-kick-verification=pass ground_frames=70 air_frames=59 air_land_frames=65 ground_edge_frames=70"
