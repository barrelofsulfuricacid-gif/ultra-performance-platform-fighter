...
def generate(raw: bytes) -> str:
    ...
    ground_input_attributes = {
        ...
        "platform_drop_axis_threshold": round(
            platform_drop_axis_threshold * 32767.0
        ),
    ...
    lines = [
        ...
        "",
        "static const uint8_t ssbm_common_source_sha256[32] = {",
        "    "
        + ", ".join(
        ...
        "ssbm_common_raw_words[PF_M4_SSBM_COMMON_RAW_WORD_COUNT] = {",
    ]
    lines.extend(
        "    "
        + ", ".join(
    ...
    lines.extend(
        [
            ...
            "ssbm_jump_backward_axis_threshold =",
            ...
            "};",
            "",
            "static const ssbm_match_entry_attributes",
            "ssbm_match_entry_attribute_data = {",
