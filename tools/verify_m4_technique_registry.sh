...
END {
    ...
    if (planned != 52 || primitive_ready != 5 ||
        playable != 3 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=3 primitive_ready=5 planned=52 acceptance=blocked"
