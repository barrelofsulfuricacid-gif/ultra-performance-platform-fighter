...
END {
    ...
    if (planned != 5 || primitive_ready != 3 ||
        playable != 52 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=52 primitive_ready=3 planned=5 acceptance=blocked"
