...
END {
    ...
    if (planned != 50 || primitive_ready != 5 ||
        playable != 5 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=5 primitive_ready=5 planned=50 acceptance=blocked"
