...
END {
    ...
    if (planned != 17 || primitive_ready != 3 ||
        playable != 40 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=40 primitive_ready=3 planned=17 acceptance=blocked"
