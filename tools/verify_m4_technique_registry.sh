...
END {
    ...
    if (planned != 2 || primitive_ready != 3 ||
        playable != 55 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=55 primitive_ready=3 planned=2 acceptance=blocked"
