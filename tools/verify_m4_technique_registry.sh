...
END {
    ...
    if (planned != 33 || primitive_ready != 6 ||
        playable != 21 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=21 primitive_ready=6 planned=33 acceptance=blocked"
