...
END {
    ...
    if (planned != 35 || primitive_ready != 6 ||
        playable != 19 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=19 primitive_ready=6 planned=35 acceptance=blocked"
