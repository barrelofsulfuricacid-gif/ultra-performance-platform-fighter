...
END {
    ...
    if (planned != 6 || primitive_ready != 3 ||
        playable != 51 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=51 primitive_ready=3 planned=6 acceptance=blocked"
