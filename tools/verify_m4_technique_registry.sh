...
END {
    ...
    if (planned != 18 || primitive_ready != 3 ||
        playable != 39 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=39 primitive_ready=3 planned=18 acceptance=blocked"
