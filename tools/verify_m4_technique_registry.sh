...
END {
    ...
    if (planned != 42 || primitive_ready != 8 ||
        playable != 10 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=10 primitive_ready=8 planned=42 acceptance=blocked"
