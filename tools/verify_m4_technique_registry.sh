...
END {
    ...
    if (planned != 10 || primitive_ready != 3 ||
        playable != 47 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=47 primitive_ready=3 planned=10 acceptance=blocked"
