...
END {
    ...
    if (planned != 26 || primitive_ready != 6 ||
        playable != 28 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=28 primitive_ready=6 planned=26 acceptance=blocked"
