...
END {
    ...
    if (planned != 7 || primitive_ready != 3 ||
        playable != 50 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=50 primitive_ready=3 planned=7 acceptance=blocked"
