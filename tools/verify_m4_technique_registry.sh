...
END {
    ...
    if (planned != 31 || primitive_ready != 6 ||
        playable != 23 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=23 primitive_ready=6 planned=31 acceptance=blocked"
