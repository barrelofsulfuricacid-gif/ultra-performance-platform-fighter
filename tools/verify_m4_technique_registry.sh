...
END {
    ...
    if (planned != 0 || primitive_ready != 3 ||
        playable != 57 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=57 primitive_ready=3 planned=0 acceptance=blocked"
