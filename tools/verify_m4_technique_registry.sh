...
END {
    ...
    if (planned != 34 || primitive_ready != 6 ||
        playable != 20 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=20 primitive_ready=6 planned=34 acceptance=blocked"
