...
END {
    ...
    if (planned != 30 || primitive_ready != 6 ||
        playable != 24 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=24 primitive_ready=6 planned=30 acceptance=blocked"
