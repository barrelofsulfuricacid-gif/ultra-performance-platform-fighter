...
END {
    ...
    if (planned != 24 || primitive_ready != 4 ||
        playable != 32 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=32 primitive_ready=4 planned=24 acceptance=blocked"
