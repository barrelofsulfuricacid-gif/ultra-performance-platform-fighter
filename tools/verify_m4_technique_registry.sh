...
END {
    ...
    if (planned != 0 || primitive_ready != 2 ||
        playable != 58 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=58 primitive_ready=2 planned=0 acceptance=blocked"
