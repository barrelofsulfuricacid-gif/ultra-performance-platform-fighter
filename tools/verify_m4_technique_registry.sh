...
END {
    ...
    if (planned != 25 || primitive_ready != 4 ||
        playable != 31 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=31 primitive_ready=4 planned=25 acceptance=blocked"
