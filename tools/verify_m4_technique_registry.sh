...
END {
    ...
    if (planned != 40 || primitive_ready != 7 ||
        playable != 13 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=13 primitive_ready=7 planned=40 acceptance=blocked"
