...
END {
    ...
    if (planned != 32 || primitive_ready != 6 ||
        playable != 22 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=22 primitive_ready=6 planned=32 acceptance=blocked"
