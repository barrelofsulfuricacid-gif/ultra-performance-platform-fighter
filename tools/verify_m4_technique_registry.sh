...
END {
    ...
    if (planned != 28 || primitive_ready != 6 ||
        playable != 26 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=26 primitive_ready=6 planned=28 acceptance=blocked"
