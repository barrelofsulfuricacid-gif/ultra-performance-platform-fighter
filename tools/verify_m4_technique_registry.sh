...
END {
    ...
    if (planned != 25 || primitive_ready != 5 ||
        playable != 30 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=30 primitive_ready=5 planned=25 acceptance=blocked"
