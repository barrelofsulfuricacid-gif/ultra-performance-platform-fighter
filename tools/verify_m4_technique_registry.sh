...
END {
    ...
    if (planned != 37 || primitive_ready != 7 ||
        playable != 16 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=16 primitive_ready=7 planned=37 acceptance=blocked"
