...
END {
    ...
    if (planned != 29 || primitive_ready != 6 ||
        playable != 25 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=25 primitive_ready=6 planned=29 acceptance=blocked"
