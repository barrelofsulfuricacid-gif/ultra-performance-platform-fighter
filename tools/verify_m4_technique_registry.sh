...
END {
    ...
    if (planned != 13 || primitive_ready != 3 ||
        playable != 44 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=44 primitive_ready=3 planned=13 acceptance=blocked"
