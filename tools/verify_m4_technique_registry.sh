...
END {
    ...
    if (planned != 20 || primitive_ready != 4 ||
        playable != 36 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=36 primitive_ready=4 planned=20 acceptance=blocked"
