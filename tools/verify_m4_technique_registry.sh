...
END {
    ...
    if (planned != 21 || primitive_ready != 4 ||
        playable != 35 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=35 primitive_ready=4 planned=21 acceptance=blocked"
