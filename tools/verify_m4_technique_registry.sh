...
END {
    ...
    if (planned != 42 || primitive_ready != 7 ||
        playable != 11 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=11 primitive_ready=7 planned=42 acceptance=blocked"
