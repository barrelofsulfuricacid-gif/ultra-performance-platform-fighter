...
END {
    ...
    if (planned != 25 || primitive_ready != 6 ||
        playable != 29 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=29 primitive_ready=6 planned=25 acceptance=blocked"
