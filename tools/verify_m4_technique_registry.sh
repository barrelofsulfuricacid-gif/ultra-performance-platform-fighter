...
END {
    ...
    if (planned != 51 || primitive_ready != 5 ||
        playable != 4 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=4 primitive_ready=5 planned=51 acceptance=blocked"
