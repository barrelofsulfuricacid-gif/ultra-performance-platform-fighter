...
END {
    ...
    if (planned != 18 || primitive_ready != 4 ||
        playable != 38 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=38 primitive_ready=4 planned=18 acceptance=blocked"
