...
END {
    ...
    if (planned != 19 || primitive_ready != 4 ||
        playable != 37 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=37 primitive_ready=4 planned=19 acceptance=blocked"
