...
END {
    ...
    if (planned != 1 || primitive_ready != 3 ||
        playable != 56 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=56 primitive_ready=3 planned=1 acceptance=blocked"
