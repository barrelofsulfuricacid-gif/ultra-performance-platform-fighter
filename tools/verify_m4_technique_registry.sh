...
END {
    ...
    if (planned != 48 || primitive_ready != 5 ||
        playable != 7 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=7 primitive_ready=5 planned=48 acceptance=blocked"
