...
END {
    ...
    if (planned != 27 || primitive_ready != 6 ||
        playable != 27 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=27 primitive_ready=6 planned=27 acceptance=blocked"
