...
END {
    ...
    if (planned != 22 || primitive_ready != 4 ||
        playable != 34 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=34 primitive_ready=4 planned=22 acceptance=blocked"
