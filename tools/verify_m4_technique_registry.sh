...
END {
    ...
    if (planned != 41 || primitive_ready != 7 ||
        playable != 12 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=12 primitive_ready=7 planned=41 acceptance=blocked"
