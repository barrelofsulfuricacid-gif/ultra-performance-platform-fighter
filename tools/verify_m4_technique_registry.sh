...
END {
    ...
    if (planned != 11 || primitive_ready != 3 ||
        playable != 46 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=46 primitive_ready=3 planned=11 acceptance=blocked"
