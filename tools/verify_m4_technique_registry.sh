...
END {
    ...
    if (planned != 12 || primitive_ready != 3 ||
        playable != 45 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=45 primitive_ready=3 planned=12 acceptance=blocked"
