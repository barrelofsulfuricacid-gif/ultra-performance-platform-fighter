...
END {
    ...
    if (planned != 16 || primitive_ready != 3 ||
        playable != 41 || verified != 1)
    {
...
echo "m4-technique-registry=pass rows=61 verified=1 playable=41 primitive_ready=3 planned=16 acceptance=blocked"
