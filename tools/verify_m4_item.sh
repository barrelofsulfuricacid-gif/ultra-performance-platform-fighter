...
grep -Fqx \
    'm4-item=pass content_schema=37 state_schema=36 save_bytes=694 item_invariants=44 bat_drop=1 glide_toss=1 jump_cancel_throw=1 directional_throws=4 replay=1 rl=1' \
