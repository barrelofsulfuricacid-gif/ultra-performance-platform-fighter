...
compiler=${CC:-cc}
expected='m4-projectile=pass content_schema=56 state_schema=52 save_bytes=787 projectile_invariants=46 short_hop_laser=1 powershield_reflect=1 replay=1 rl=1 emergent_technique_tests=skipped'
