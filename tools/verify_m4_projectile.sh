...
compiler=${CC:-cc}
expected='m4-projectile=pass content_schema=42 state_schema=40 save_bytes=694 projectile_invariants=46 short_hop_laser=1 camping=1 powershield_reflect=1 replay=1 rl=1'
