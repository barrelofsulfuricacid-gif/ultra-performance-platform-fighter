...
compiler=${CC:-cc}
expected='m4-projectile=pass content_schema=31 state_schema=30 save_bytes=690 projectile_invariants=38 short_hop_laser=1 powershield_reflect=1 replay=1 rl=1'
