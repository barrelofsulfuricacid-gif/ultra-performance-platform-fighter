...
compiler=${CC:-cc}
expected='m4-projectile=pass content_schema=52 state_schema=49 save_bytes=771 projectile_invariants=46 short_hop_laser=1 camping=1 powershield_reflect=1 replay=1 rl=1'
