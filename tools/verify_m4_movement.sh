...
grep -Fqx \
    'm4-movement=pass content_schema=35 deterministic_ticks=20000 movement_invariants=285 moonwalk=1 teeter_cancel=1 taunt_cancel=1 stage_humping=1 double_jump_cancel=1 ledge_cancel=1 planking=1' \
