...
grep -Fqx \
    'm4-movement=pass content_schema=1 deterministic_ticks=20000 movement_invariants=13' \
    "$output_dir/m4_movement.txt"

echo "m4-movement-verification=pass invariants=13 deterministic_ticks=20000"
