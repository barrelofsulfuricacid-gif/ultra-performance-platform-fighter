...
grep -Fqx \
    'm4-movement=pass content_schema=53 deterministic_ticks=20000 movement_invariants=350 jump_takeoff_momentum=1 moonwalk=1 teeter_cancel=1 taunt_cancel=1 scar_jump=1 stage_humping=1 double_jump_cancel=1 vector_ascent=1 ledge_cancel=1 planking=1 ledge_roll=1' \
    "$output_dir/m4_movement.txt"

echo "m4-movement-verification=pass invariants=349 moonwalk=1 teeter_cancel=1 taunt_cancel=1 scar_jump=1 stage_humping=1 deterministic_ticks=20000 double_jump_cancel=1 vector_ascent=1 ledge_cancel=1 planking=1 ledge_roll=1"
