...
echo "m4-movement-verification=pass invariants=285 moonwalk=1 teeter_cancel=1 taunt_cancel=1 stage_humping=1 deterministic_ticks=20000 double_jump_cancel=1 ledge_cancel=1 planking=1"
