...
grep -Fqx \
    'm4-movement=pass content_schema=16 deterministic_ticks=20000 movement_invariants=150' \
    "$output_dir/m4_movement.txt"

echo "m4-movement-verification=pass invariants=150 deterministic_ticks=20000"
