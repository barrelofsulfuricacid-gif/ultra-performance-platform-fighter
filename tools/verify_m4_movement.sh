...
grep -Fqx \
    'm4-movement=pass content_schema=17 deterministic_ticks=20000 movement_invariants=152' \
    "$output_dir/m4_movement.txt"

echo "m4-movement-verification=pass invariants=152 deterministic_ticks=20000"
