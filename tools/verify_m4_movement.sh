...
grep -Fqx \
    'm4-movement=pass content_schema=14 deterministic_ticks=20000 movement_invariants=104' \
    "$output_dir/m4_movement.txt"

echo "m4-movement-verification=pass invariants=104 deterministic_ticks=20000"
