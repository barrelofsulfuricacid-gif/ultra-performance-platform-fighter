...
grep -Fqx \
    'm4-movement=pass content_schema=15 deterministic_ticks=20000 movement_invariants=131' \
    "$output_dir/m4_movement.txt"

echo "m4-movement-verification=pass invariants=131 deterministic_ticks=20000"
