...
grep -Fqx \
    'm4-movement=pass content_schema=19 deterministic_ticks=20000 movement_invariants=170' \
    "$output_dir/m4_movement.txt"

echo "m4-movement-verification=pass invariants=170 deterministic_ticks=20000"
