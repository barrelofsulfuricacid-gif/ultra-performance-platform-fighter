...
grep -Fqx \
    'm4-movement=pass content_schema=9 deterministic_ticks=20000 movement_invariants=35' \
    "$output_dir/m4_movement.txt"

echo "m4-movement-verification=pass invariants=35 deterministic_ticks=20000"
