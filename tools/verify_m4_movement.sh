...
grep -Fqx \
    'm4-movement=pass content_schema=10 deterministic_ticks=20000 movement_invariants=53' \
    "$output_dir/m4_movement.txt"

echo "m4-movement-verification=pass invariants=53 deterministic_ticks=20000"
