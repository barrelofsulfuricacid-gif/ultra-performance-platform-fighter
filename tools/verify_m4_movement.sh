...
grep -Fqx \
    'm4-movement=pass content_schema=6 deterministic_ticks=20000 movement_invariants=30' \
    "$output_dir/m4_movement.txt"

echo "m4-movement-verification=pass invariants=30 deterministic_ticks=20000"
