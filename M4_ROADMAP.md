...
- [ ] Import the process-global HSD RNG state/call ordering needed for
  Wait2/Wait3. Until then production clamps the last qualified base-Wait pose
  and makes no complete-idle equivalence claim.
