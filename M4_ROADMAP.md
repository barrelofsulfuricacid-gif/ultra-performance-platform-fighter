...
- [x] Pass Windows Release 35/35 in 2.23 seconds with bounded two-way test
  scheduling and WSL Release 35/35 in 1.11 seconds after the dynamic ground-loop
  import. The latest stored gate covers all 20 domains / 116 cases plus replay
  in 0.677 seconds on Windows and 1.308 seconds in WSL. WSL ASan/UBSan passes
