...
- [x] Extend `falcon-common-hurt` to 714 poses. The fresh 16-case / 323-row
  ...
  GuardSetOff's dynamic shield-stun pose remains the next guard-geometry gap.
