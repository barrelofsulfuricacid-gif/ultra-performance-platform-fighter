...
- [x] Add four physical simultaneous-input discriminators. Walk Z+B enters
  Grab; low non-neutral Walk B enters Falcon Punch; Wait Z+B enters Falcon
  Punch; and Wait up+A+B enters Falcon Dive. Twelve isolated cases / 160 rows
...
- [x] The complete 25-domain / 154-case plus replay registry passes in
  1.129 seconds on Windows and 1.210 seconds in WSL. Windows and WSL Release
...
- [x] Register the generic native-CSV domain. The complete 25-domain /
  154-case plus replay gate passes below two seconds on Windows and WSL.
...
- [x] Qualify twelve actual-input cases / 160 rows: Turn rejects neutral B and
  ...
  A+B up-special chord cannot leak into authored charge. Two fresh captures
  are byte-identical at raw SHA-256
  `eed4476d41a97641c48114b453985f0306ab55785aeb49c4be8869e1fc51f5e5`;
  source and production share semantic SHA-256
  `92ed40ead35b06ae754f1289a585ca0744fa3864adf5a25ed2d4f06278a09867`.
  Warm capture times are 1.693 and 1.447 seconds.
