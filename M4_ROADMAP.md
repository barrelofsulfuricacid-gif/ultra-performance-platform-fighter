...
| Slippi replay differential | all 782 downloaded Falcon replays swept; continuous watcher active | The character-independent worker keeps exact disc/UCF/raw-input provenance fail-closed while permitting explicitly labeled diagnostic discovery. The full hash-pinned MIT corpus ran with eight parser workers in 777.694 seconds: 782 parsed, 328 natural anchors, 111 executable comparisons, 2,475 checked frames, 39 passes, 7 UCF dashback boundaries, and 72 deterministic candidates. Public metadata does not independently prove the disc/UCF revision, so none are exact-equivalence claims. Two independent prefixes exposed terminal KneeBend ownership and two-stage trigger delivery: Melee installs Jump before IASA, and analog travel may reach its endpoint before the digital L/R click. Production now projects terminal JumpSquat before routing; the adapter reserves `65535` for the physical click and caps unclicked analog at `65534`. The minimized replay advances through wavedash after the fix. Eighteen Python tests plus Windows/WSL movement tests pass. Full ignored manifest/report SHA-256: `f42d437ee166b07502a7af8316aa2ee0b473ea487802b1327ae673171493b477` / `154ae335f86fa91aa6bbc5fe0bb0a6908d594efd44f0d220bcdba27e238a6e8f`. |
