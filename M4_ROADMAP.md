...
| Fast stored equivalence | thirty-five-domain UCF/raw-input registry; every Falcon-relevant UCF hook family has a direct boundary domain | The current registry contains 35 domains / 238 cases. The common special-acquisition pack owns 39 cases / 491 samples and now includes exact prior-versus-current Jump-entry input ordering plus early Turn-origin Dash reversal, alongside the existing callback-order, UCF/vanilla reversal, InitialDash provenance, and GuardOn-origin matrix. Focused Windows production hashes to `dfdf53934818d7436fa02fc265e3febb129e97f34b1573d0b670cfc66075a6c6`; the source trace hashes to `c68d3bc9cd830283648f98b210502a471ca0724fc3b5197caea5b71aaa29a07b`, differing only by one allowed Q16 unit on the second held-jump horizontal sample. Earlier registry counts and measurements later in this file remain historical checkpoints. The current replay golden is temporarily open because the corrected jump-entry semantics invalidate its authored interaction-coverage route; this does not block the focused live/stored domains. |
