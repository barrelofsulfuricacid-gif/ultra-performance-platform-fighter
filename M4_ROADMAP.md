...
- [x] Register the generic native-CSV domain. The complete 25-domain /
  150-case plus replay gate passes in 1.139 seconds on Windows and 0.923
  seconds in WSL. The focused 17-case lane takes 0.880/0.417 seconds.
