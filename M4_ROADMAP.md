...
| --- | --- | --- |
| Fast stored equivalence | done for thirty registered domains plus focused Wait lifecycle | The registry contains 174 cases plus deterministic replay and passes below the two-second budget in three isolated runs per platform: 1178.830/1319.197/1471.076 ms on Windows and 919.397/986.464/1270.306 ms in WSL. The new four-case/127-sample Run-to-RunBrake domain passes by itself in 263.089 ms on Windows and 403.007 ms in WSL. The pose domains hash 1,290 production poses: 714 common/ledge/guard, 33 Turn/TurnRun, 186 ordinary-airborne, 79 Pummel/CaptureWaitHi/CaptureDamageHi, and 278 CrouchWait/Appeal poses. Raptor Boost adds 502 field-masked numeric samples, Falcon Kick adds 399, natural movement adds 520, the five aerial-landing routes add 685, passive shield break adds 500, grounded slope damage adds 120, released Damage/DamageFall air-dodge IASA adds four exact action/tumble samples, Run-to-RunBrake acquisition adds 127 exact action/tick/facing/grounded samples, common special acquisition adds 188, KneeBend up-special acquisition adds 18, crouch up-special acquisition adds 106, aerial neutral-special turnaround adds 91, teeter special acquisition adds 28, and GuardOff acquisition adds 119. The seven exact acquisition domains require their production canonical digest to equal the live-source digest; two independently pinned regression digests are not accepted as equivalence. Independent domains run concurrently while output retains manifest order. Eight fractional ground-loop, three direct Wait, six SquatRv-to-Wait entry, 32 Wait2/Wait3 lifecycle, and nine pressure-derived GuardSetOff observations use shared C pose gates. The Wait lifecycle also has its own focused 440-tick/38-pose native CTest. |
