...
| Fast stored equivalence | thirty-two-domain UCF/raw-input registry; cardinal domain passes | The registry now contains 32 domains / 205 cases and passes with deterministic replay under manifest SHA-256 `26b925f08337c64e8cb8db9c5de7e47488d92b2fc3a6dd887894f53cbd095647`; three isolated complete runs take 877.821-1,033.078 ms on Windows and 908.291-971.404 ms in WSL. The new 16-case / 48-sample `falcon-common-ucf084-cardinal-input` domain requires exact source/production equality at SHA-256 `4a553ba57522d4347188cb227357157fbb4f1a7246dd638fba68019e9166fd63`; direct verifier-only execution takes 232.529-251.415 ms on Windows and 453.341-678.188 ms in WSL. The preceding complete 31-domain / 189-case registry and the completed 31-domain / 186-case measurements later in this file remain historical checkpoints. The current 240-tick replay remains 42,555 bytes at corpus/final/event SHA-256 `a1d9c1d97a3f20bdb9c76094c39b856f731a1eb2c0cca64ac05dd28a6e121949` / `3bdbbbc5d7faa6c8fd077ebd47aaa061f738a3561aa4c66ae2bfe4f8455cda6a` / `a4020969be032543b9b229c8801bde77581b9f7fe26a9fe8aca91527627b13ec`. |
| Fast live Dolphin oracle | Dashback/raw-history and PAD/cardinal slices live-qualified; six UCF hook families remain | Registered packs continue to use headless/null/unlimited ExiAI and checkpoint-isolated cases. The UCF common-special pack's 19 cases / 210 rows directly qualify raw-history/Dashback and delayed-Turn primitives at exact source/production digest `6b50b9b36d47fb6a4b77bef5a951f03b311898fd88b481ff798909e05749f079`. The separate PAD/cardinal pack contributes 16 cases / 48 rows; independent capture SHA-256 values are `d6d7cb26d0b30785bb38c39a6b400366742998d6f9f2eeb448f4a7cb31db4984` and `b46ef4c579a26050f6cb8f9eda6c6c5068dd5b62ac65eae4ccdc0d9847075372`, while their canonical source projections and production are exactly equal at SHA-256 `4a553ba57522d4347188cb227357157fbb4f1a7246dd638fba68019e9166fd63`. Slippi's serialized raw main- and C-stick bytes are the authority for the current physical sample, while DME reads of source-owned fighter axes prove the post-UCF processed result. The two four-worker captures take 7.349/6.883 seconds; parent warm time is 8.097/7.357 seconds and cold time is 9.728/8.722 seconds, within the manifest's 12-second warm and 20-second cold budgets. DBOOC, SDI, shield SDI, tumble, shield-drop suppression, and extended-pad-counter behavior remain six direct live boundary families. |
...
| Web acceptance architecture | duplicate probes removed; current replay smoke passes | Four source-grep verifier scripts and duplicated gameplay scenarios are deleted. The compact `web.m4_playtest` gate now protects only the real bridge ABI: exact main/C-stick/button/independent-trigger forwarding, Team Lab slot routing, and dynamic shield/hit-sphere packing. The generated Emscripten page and real headless Chrome smoke pass the current 42,555-byte replay with ABI 5, final SHA-256 `3bdbbbc5d7faa6c8fd077ebd47aaa061f738a3561aa4c66ae2bfe4f8455cda6a`, and 84 re-simulated typed events. Collision-toggle, result/rematch, and replay-navigation/fail-closed import remain honestly named owner-interaction gates instead of being overclaimed from a static DOM dump. |
| Slippi replay differential | exact UCF input path implemented; tracked legacy corpus fail-closed | The character-independent worker and five-file CC0 Falcon corpus remain diagnostic discovery infrastructure. The extractor now walks the file-declared Slippi event framing to retain physically serialized raw main X/Y and cross-checks raw X against pinned `slippi-js`; an exact processed/raw pair reaches the production CSV runner through its 12-field row with validity mask `3`. The former unsupported-UCF-raw-history suppression is removed only after a corpus entry proves the GALE01 revision-2 disc, pinned UCF 0.84, observed UCF controller-fix family, and both raw main axes. A production probe using raw X `0,-40,-76,0` now reaches `Standing -> Turn 1 -> Dash 1 -> Dash 2`, exercising the 75/76 UCF dashback edge, and 16 focused tests pass. A fresh bounded run hash-verifies and parses all five tracked files and rediscovers nine anchors, but executes zero: every legacy Slippi 2.0.1 file has a 63-byte pre-frame payload (exact raw X, no raw Y) and lacks independent disc/UCF-revision proof. The report classifies all five as `unsupported-reference-configuration`; the earlier five movement candidates remain diagnostic history and are not promoted, dismissed, or counted as current exact-reference gaps. |
