...
- [x] Qualify four special directions, one ordinary-shield special negative,
  and ordinary/powershield jump plus spot dodge through physical Falcon Jabs.
  ...
  unbatched EXI input. Two 63-row captures are byte-identical at raw SHA-256
  ...
  Warm captures take 1.798 and 1.797 seconds.
- [x] Register the generic native-CSV domain. The complete 25-domain /
  142-case plus replay gate passes in 1.590 seconds on Windows and 1.829
  seconds in WSL. The focused nine-case lane takes 0.344/0.370 seconds.
