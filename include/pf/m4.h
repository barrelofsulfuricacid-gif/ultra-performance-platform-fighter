...
#define PF_M4_CONTENT_SCHEMA_VERSION UINT16_C(69)
#define PF_M4_FIGHTER_SCHEMA_VERSION UINT16_C(62)
...
typedef struct pf_m4_fighter_data
{
    ...
    int32_t platform_drop_speed_y_q16;
    ...
    uint8_t reserved2;
    uint16_t stale_move_slot_reduction_q16[
