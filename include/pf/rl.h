...
#define PF_RL_SCHEMA_VERSION UINT16_C(12)
#define PF_RL_ACTION_SCHEMA_VERSION UINT16_C(1)
#define PF_RL_TRANSITION_SCHEMA_VERSION UINT16_C(10)
#define PF_RL_COMPACT_OBSERVATION_SCHEMA_VERSION UINT16_C(11)
...
#define PF_RL_COMPACT_SHIELD_HEALTH_VALUES UINT16_C(4)
#define PF_RL_COMPACT_SHIELD_HEALTH_BASE UINT16_C(74)
#define PF_RL_COMPACT_SHIELD_TILT_VALUES UINT16_C(8)
#define PF_RL_COMPACT_SHIELD_TILT_BASE UINT16_C(78)
#define PF_RL_COMPACT_STALE_MOVE_PLAYER_STRIDE UINT16_C(4)
#define PF_RL_COMPACT_STALE_MOVE_BASE UINT16_C(86)
#define PF_RL_COMPACT_VALUE_COUNT UINT16_C(102)
...
#define PF_RL_COMPACT_STALE_MOVE_MULTIPLIER_OFFSET UINT16_C(0)
#define PF_RL_COMPACT_STALE_MOVE_COUNT_IDS_0_2_OFFSET UINT16_C(1)
#define PF_RL_COMPACT_STALE_MOVE_IDS_3_6_OFFSET UINT16_C(2)
#define PF_RL_COMPACT_STALE_MOVE_IDS_7_8_OFFSET UINT16_C(3)
#define PF_RL_COMPACT_STALE_MOVE_PLAYER_BASE(slot)                  \
    ((uint16_t)(PF_RL_COMPACT_STALE_MOVE_BASE +                     \
                (uint16_t)(slot) *                                  \
