...
#define PF_RL_COMPACT_STALE_MOVE_PLAYER_STRIDE UINT16_C(11)
#define PF_RL_COMPACT_STALE_MOVE_BASE UINT16_C(86)
#define PF_RL_COMPACT_VALUE_COUNT UINT16_C(130)
...
#define PF_RL_COMPACT_STALE_MOVE_COUNT_OFFSET UINT16_C(0)
#define PF_RL_COMPACT_STALE_MOVE_MULTIPLIER_OFFSET UINT16_C(1)
#define PF_RL_COMPACT_STALE_MOVE_IDS_OFFSET UINT16_C(2)
