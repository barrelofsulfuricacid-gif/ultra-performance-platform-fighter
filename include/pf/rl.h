...
#define PF_RL_SCHEMA_VERSION UINT16_C(3)
#define PF_RL_ACTION_SCHEMA_VERSION UINT16_C(1)
#define PF_RL_TRANSITION_SCHEMA_VERSION UINT16_C(3)
#define PF_RL_COMPACT_OBSERVATION_SCHEMA_VERSION UINT16_C(3)
#define PF_RL_COMPACT_GLOBAL_VALUES UINT16_C(8)
#define PF_RL_COMPACT_PLAYER_STRIDE UINT16_C(10)
#define PF_RL_COMPACT_VALUE_COUNT UINT16_C(48)
