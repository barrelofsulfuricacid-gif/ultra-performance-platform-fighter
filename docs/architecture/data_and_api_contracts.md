...
Save formats 1–14 remain historical checkpoints. The current M4
movement/combat state uses save format 15: a fixed 603-byte checkpoint with
state schema 16 and canonical solid-surface tech/bounce,
...
flight/down/stand/stun action semantics without adding payload fields. Format
