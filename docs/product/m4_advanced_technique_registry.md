...
| 55 | Teching | primitive-ready | M4.4 | Ground tech in place/roll, missed-tech down-wait/getups, and exact invulnerability exist; wall/ceiling tech remains | `tests/sim/test_m4_combat.c` covers tech and missed-tech outcomes, recovery timing, and rejected/accepted hits; browser reaction/floor probes and invulnerability inspection | Current partial recipe: trigger within 20 ticks of tumble landing for in-place/roll or miss the input for all floor getups, then observe the gold invulnerability ring clear; future complete recipe adds wall and ceiling impacts |
