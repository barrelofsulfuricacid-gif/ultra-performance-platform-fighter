...
| 55 | Teching | primitive-ready | M4.4 | Ground tech in place/roll and their 20-tick invulnerability exist; wall/ceiling tech and complete outcomes remain | `tests/sim/test_m4_combat.c` covers exact invulnerability end plus rejected/accepted hits; browser reaction startup probe and invulnerability inspection | Current partial recipe: trigger within 20 ticks of tumble landing for in-place/roll, observe the gold invulnerability ring clear while the action continues; future complete recipe adds wall and ceiling impacts |
