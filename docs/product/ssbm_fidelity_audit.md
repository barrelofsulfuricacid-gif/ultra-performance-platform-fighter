...
Slippi's serialized raw main- and C-stick bytes own the current raw sample;
...
That preceding full registry passes under manifest SHA-256
...
position, velocity, and observed controller sample. `movement_trace`
