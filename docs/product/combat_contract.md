...
`tests/sim/test_projectile.c` runs both fixed-input policies through
...
`tests/sim/test_item.c` supplies 44 focused invariants, all four directional
...
`tests/sim/test_projectile.c` supplies 38 focused invariants covering
...
`tests/sim/test_reflector.c` supplies 32 invariants covering data validation
...
`tests/sim/test_charge.c` supplies 28 focused invariants covering disabled
...
`tests/sim/test_movement.c` supplies focused recovery invariants:
...
`tests/sim/test_movement.c` covers authored-data validation and hashing,
...
`tests/sim/test_combat.c` covers both handoffs, exact event attribution,
...
`tests/sim/test_combat.c` and `tools/verify_combat.sh` cover 982 focused
...
`tests/sim/test_match.c` and `tools/verify_match.sh` retain 24 match
