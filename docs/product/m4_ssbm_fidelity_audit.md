...
3. Extend Falcon Dive qualification to edge routes and extend Raptor Boost
   qualification through the aerial-hit tail, edge-conversion, and source
   item-search routes.
...
evidence is 14,530 captured frames. The memory-probed routes qualify the
