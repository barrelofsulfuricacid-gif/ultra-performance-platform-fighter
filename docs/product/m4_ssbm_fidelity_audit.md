...
3. Capture common-state hurt poses beyond Initial Dash/RunBrake/CrouchStart/
   CrouchEnd/KneeBend/SpotDodge/RollForward/RollBackward and qualify remaining aerial-IASA branches and unsampled dynamic
