...
3. Capture remaining common-state hurt poses and qualify source-Z collision,
   aerial IASA, and unsampled dynamic routes without duplicating constants.
