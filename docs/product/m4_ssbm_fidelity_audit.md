...
| Ground and platform collision | partial | The isolated 348-frame Battlefield route matches neutral jump-through ascent, the final ordinary-airborne descending crossing before `Landing`, 0.63 Pass entry speed, and same-frame solid-floor landing. The original 540-frame Final Destination Falcon-versus-Falcon route and a new checkpoint-isolated 48-row / 96-lane registered domain both match grounded push from both directions and controller ports. Action, facing, and grounded state are strict; velocity permits 32 Q16 units and position retains the reviewed 2,692-Q16 delayed-overlap envelope. Three fresh boots share source digest `3c6ade86d516474c60b7559690b3b858f2b7a66b41982859e4f81df70a7c73f5`; the stored production digest is `079a34868db4fff30719d7a784d7bd102aab7a81acd189ad6293c65a9056bc7a`. General stage collision primitives and broader ECB evolution remain unqualified. |
...
| Tech and neutral getup body state | partial | The generated script decoder covers all 318 submotions and exposes raw state-2/state-0 command frames. A four-case, 804-row Final Destination domain qualifies flat-floor missed tech, neutral tech, and both directional techs: 26/26/40/40 displayed frames, frames 1-20 tech invulnerability, retained hitstun memory, imported forward/backward `TransN`, and the source 220-frame DownWait value. Wall/ceiling tech timing, invulnerability, release velocity, and ceiling control are separately Dolphin-qualified. Both prone orientations now qualify DownBound ECB contact, DownWait timeout/input priority, neutral getup, directional main/C-stick rolls, and buffered getup attacks. Complete prone pose geometry, slopes, and ledge departure still need separate qualification. |
