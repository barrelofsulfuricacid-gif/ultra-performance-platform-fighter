...
Current Falcon Dive boundary: the facing-toward ledge theorem remains green,
and production follows the decomp's bidirectional start-state ledge query. The
capture-authored aerial catch placement is now a separate exact-position
