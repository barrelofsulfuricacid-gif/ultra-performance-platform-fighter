...
3. Capture common-state hurt poses beyond Initial Dash/RunBrake and qualify remaining
   aerial-IASA branches and unsampled dynamic routes without duplicating
   constants.
