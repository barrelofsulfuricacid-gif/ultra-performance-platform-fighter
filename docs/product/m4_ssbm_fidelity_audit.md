...
3. Extend Falcon Dive qualification to edge routes and extend Raptor Boost
   qualification through source item-search routes.
...
evidence is 14,671 captured frames. The memory-probed routes qualify the
