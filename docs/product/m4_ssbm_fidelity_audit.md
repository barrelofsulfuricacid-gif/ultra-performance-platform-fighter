...
3. Extend Falcon Dive qualification to edge routes and extend Raptor Boost
   qualification to aerial hit, edge-conversion, and source item-search routes.
...
evidence is 14,475 captured frames. The memory-probed routes qualify the
