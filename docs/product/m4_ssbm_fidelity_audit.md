...
3. Capture common-state hurt poses beyond Initial Dash/RunBrake/CrouchStart/
   ...
   FallSpecial/LandingFallSpecial and qualify remaining aerial-IASA branches and unsampled dynamic
