...
A separate 285-frame defense-state capture has SHA-256
...
upward air dodge through ordinary-physics handoff and floor landing. The
comparator now checks invulnerability as an exact discrete field in addition
...
evidence is 17,923 captured frames. The memory-probed routes qualify the
