...
3. Capture common-state hurt poses beyond Initial Dash/RunBrake/CrouchStart/
   CrouchEnd and qualify remaining aerial-IASA branches and unsampled dynamic
...
evidence is 18,273 qualified frames. The memory-probed routes qualify the
