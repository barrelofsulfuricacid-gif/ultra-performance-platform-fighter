...
3. Capture remaining common-state hurt poses and qualify moving hit-capsule
   sweeps, remaining aerial-IASA branches, and unsampled dynamic routes without duplicating
   constants.
