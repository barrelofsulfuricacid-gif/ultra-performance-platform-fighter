...
| Ground and platform collision | partial | The isolated 348-frame Battlefield route matches neutral jump-through ascent, the final ordinary-airborne descending crossing before `Landing`, 0.63 Pass entry speed, and same-frame solid-floor landing. The paired 48-row / 96-lane domain matches grounded push from both directions and controller ports. The imported Hyrule line-34 slope and line-36/37 endpoint domain additionally qualifies slope-tangent landing projection, DamageFly ECB, DownBound contact/support ordering, collision-driven Fall, and the exact ordinary ledge entry through seven `CliffCatch` frames and first `CliffWait`; its source/production digests are `0b23132b7a217ff173397faf8ac9e59169092c99095b4b4e3fbd885526b7a3f3` and `9c562426f42c4b01b08a7bbea9c667f56661a2787d107870a14208f326ccd94e`. General platform/edge shapes, ordinary Fall animation phase, later wait/options, and broader ECB evolution remain unqualified. |
