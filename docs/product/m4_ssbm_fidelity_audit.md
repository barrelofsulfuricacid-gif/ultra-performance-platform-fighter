...
| Ground and platform collision | partial | The isolated 348-frame Battlefield route matches neutral jump-through ascent, the final ordinary-airborne descending crossing before `Landing`, 0.63 Pass entry speed, and same-frame solid-floor landing. The paired 48-row / 96-lane domain matches grounded push from both directions and controller ports. The imported Hyrule line-34 slope and line-36/37 endpoint domain additionally qualifies slope-tangent landing projection, DamageFly ECB, DownBound contact/support ordering, collision-driven Fall, and exact ordinary ledge catch; its source/production digests are `8c62ce678732b38d157f1e3cee2409b0da22835bc63c906c41e765ce1a879a6d` and `4dce7db6baa8a11fb90b77438ef5e423b500e5e5a3f7a4da835bfc979d6f0167`. General platform/edge shapes, ordinary Fall animation phase, EdgeCatch/EdgeWait pose tracks, and broader ECB evolution remain unqualified. |
| Ledge jump velocities | equivalent | Falcon 1.0 horizontal and 3.3 vertical attributes are mapped. |
| Other ledge actions | partial | Ordinary airborne reach now consumes imported Falcon snap attributes, source-root/ECB coordinates, Hyrule endpoint/ledge flags, current/previous positions, and matches the exact live EdgeCatch entry frame. Hang, drop, climb, roll, attack, regrab lockout, separate EdgeCatch/EdgeWait animation-root tracks, and percent-dependent ledge tables remain incomplete. |
