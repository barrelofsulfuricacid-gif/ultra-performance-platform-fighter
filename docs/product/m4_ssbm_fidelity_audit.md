...
3. Route Falcon Dive and Falcon Kick from the imported timing, attributes,
   animation translation, and pose/hit geometry, then qualify each source state
   and collision transition against Dolphin. Extend Raptor Boost qualification
