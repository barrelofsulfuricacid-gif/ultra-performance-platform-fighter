...
3. Represent transformed bone-relative hitbox geometry and route normal-throw
   collateral hitboxes without duplicating constants or collapsing
   simultaneous distinct effects.
