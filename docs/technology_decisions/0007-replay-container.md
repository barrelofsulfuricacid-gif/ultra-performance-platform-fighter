...
Replay API schema 3 and verification schema 2 embed the ABI-6 tick-result
...
- Replay size (42,572 bytes) and hashes are regenerated by the
  native/WebAssembly corpus for M4 state schema 82 / save format 72 / RNG
  behavior version 2.
